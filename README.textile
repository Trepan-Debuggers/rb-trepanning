...
__In order to use this debugger, you'll need a patched Ruby 1.9 and some additional packages. See the "installation instructions.":http://wiki.github.com/rocky/rbdbgr/how-to-install-rbdbgr__

I realize installations is a bit of a pain. Right now this debugger is geared more for those who are willing to roll up their sleeves and help out than for novices.
