...
Right now this debugger is geared more for those who are willing to roll up their sleeves and help out than for novices.

A google group mailing list for this debugger can be found at http://groups.google.com/group/ruby-debugger

If the rbdbgr is installed, here is how you can run:
